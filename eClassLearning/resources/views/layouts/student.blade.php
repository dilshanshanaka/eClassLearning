    ...
    <div class="content py-8 md:px-10 px-4 bg-slate-100">
        ...
        <div class="py-8 md:flex md:space-x-8">
            ...
            <div class="md:basis-1/6 shadow-xl bg-white p-3 rounded-lg max-h-fit">
                ...
                <h4 class="text-center text-lg font-semibold text-gray-900">{{ $student->first_name }} {{ $student->last_name }}</h4>
                ...
                <ul class="py-1 text-sm text-gray-800" aria-labelledby="sideMenu">
                    <li>
                        <a href="{{ route('student.dashboard') }}" class="block py-2 px-2 rounded hover:bg-blue-100 my-1 @if($title === 'dashboard') bg-sky-100 @endif"><i class="fa-solid fa-table-columns"></i>&emsp;Dashboard</a>
                    </li>
                    <li>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(e) {
            ...
            $('#profileImageInput').change(function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: `{{ route('student.profileImage') }}`,
                    data: formData,
                    headers: {
