...
<div class="py-20 bg-gray-100 text-center">
    <h1 class="text-4xl uppercase text-gray-700 font-bold ">{{ $mainCategory->title }}</h1>
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 capitalize">{{ $mainCategory->title }}</span>
                </div>
            </li>
        </ol>
    </nav>
